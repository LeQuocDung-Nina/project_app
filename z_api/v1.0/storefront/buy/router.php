<?php
	...
	$requick = array(
		...
		array("tbl" => "product", "field" => "id", "source" => "product", "com" => "product", "type" => "product", "menu" => true),


		array("tbl" => "product", "field" => "id", "source" => "product", "com" => "dat-hang-theo-yeu-cau", "type" => "dat-hang-theo-yeu-cau", "menu" => true),
	...
	switch($com)
	{
		...
		case 'dat-hang-theo-yeu-cau':
			$source = "product";
			$template = isset($_GET['id']) ? "product/product_detail" : "product/product";
			$seo->set('type',isset($_GET['id']) ? "article" : "object");
			$type = $com;
			$titleMain = "Đặt hàng theo yêu cầu";
			break;
